...
export function startTablet(setSigCaptured)
{
  try
  {
	...
	*/
      ...
      const data = "You are about to sign an SPF document. Please press Continue.";
  ...
  {
    alert("Unable to communicate with SigWeb. Please confirm that SigWeb is installed and running on this PC.1");
  }
...
//   console.log('listen')
  window.onload = () => {
    ...
    if(IsSigWebInstalled()){
      ...
      alert("Unable to communicate with SigWeb. Please confirm that SigWeb is installed and running on this PC2.");
    }
  };
